      ...
      <ul>
         {
            ...
            newsCategories.length > 0 ? newsCategories.map((eachNewsCategory => <li className="py-3 text-xl text-gray-950 hover:bg-red-500 hover:text-white px-2" key={eachNewsCategory.id}>
